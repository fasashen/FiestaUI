  ...
  (function($, window) {
    ...
    BootstrapSwitch = (function() {
      ...
      BootstrapSwitch.prototype._width = function() {
        ...
        $handles = this.$label.css("width", this.options.labelWidth+"vw");;
		$handles.add(this.$on.add(this.$off).css("width", this.options.handleWidth+"vw"));
        
        this._handleWidth = this.options.handleWidth;
        this._labelWidth = this.options.labelWidth;
        this.$container.width((this._handleWidth * 2) + this._labelWidth + "vw");
        return this.$wrapper.width(this._handleWidth + this._labelWidth - 2 + "vw");
      };
      ...
      BootstrapSwitch.prototype._containerPosition = function(state, callback) {
        ...
        this.$container.css("margin-left", (function(_this) {
          return function() {
            var values;
            values = [0, "-" + _this._handleWidth + "vw"];
            if (_this.options.indeterminate) {
              return "-" + (_this._handleWidth / 2) + "vw";
            }
            if (state) {
              if (_this.options.inverse) {
                return values[1];
        ...
        return this.$label.on({
          ...
          "mousemove.bootstrapSwitch touchmove.bootstrapSwitch": (function(_this) {
            return function(e) {
              ...
              return _this.$container.css("margin-left", _this._dragEnd + "vw");
            };
          })(this),
